// dupaman — Generate static article pages from articles.json
// Usage: node generate-articles.mjs

import { readFileSync, mkdirSync, writeFileSync } from 'fs';

const data = JSON.parse(readFileSync('/opt/data/dupaman/data/articles.json', 'utf-8'));
...
<style>
:root{--bg:#000;--bg2:#0d0d0d;--bg3:#141414;--bg4:#1a1a1a;--border:#1e1e1e;--border2:#2a2a2a;--green:#00ff88;--green-dim:#00cc6a;--white:#fff;--gray1:#ccc;--gray2:#888;--gray3:#444;--topic:${color}}
...
.age{color:var(--topic)}
h1{font-size:clamp(28px,5vw,44px);font-weight:800;letter-spacing:-.5px;line-height:1.25;text-wrap:balance;margin-bottom:16px}
...
<main>
  ...
  <section class="related">
    ...
    <div class="related-grid">
      ${related.map(r => `
      <a class="related-card" href="/a/${t(r.id)}.html">
...
<footer>
  <p>דופמין · חדשות ממקורות אמיתיים · <a href="/">חזרה לפיד</a></p>
</footer>
</body>
</html>`;
}

const dir = '/opt/data/dupaman/a';
mkdirSync(dir, { recursive: true });

let count = 0;
for (const article of articles) {
  const html = generateArticlePage(article, articles);
  writeFileSync(`${dir}/${article.id}.html`, html, 'utf-8');
  count++;
}

console.log(`✅ Generated ${count} article pages in ${dir}/`);